...
## Tricks for running L1 project
1. In web-based desktop, open VScode, open a new terminal to run.
2. Modify CMakeLists.txt according to [PR](https://github.com/udacity/CppND-Program-a-Concurrent-Traffic-Simulation/pull/1).
3. Use for-loop instead of for_each-loop for L1.1 TrafficObject destructor (or #include\<algorithm\> at the beginning).
4. One line of code for L1.2 Vehicle::simulate. Do NOT create a thread first then emplace_back.